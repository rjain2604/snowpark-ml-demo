...
CREATE OR REPLACE WAREHOUSE ABB_DEMO_S WAREHOUSE_SIZE=SMALL;
CREATE OR REPLACE DATABASE ABB_DEMO;
CREATE OR REPLACE SCHEMA ABB_DEMO_SCHEMA;

USE ABB_DEMO.ABB_DEMO_SCHEMA;
